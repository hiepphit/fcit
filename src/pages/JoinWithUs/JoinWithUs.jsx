...
const JoinWithUs = () => {
  return (
    <div className="Frame427320976 w-full bg-join-us bg-no-repeat bg-cover relative">
      <div className="Mqp58371 w-full h-full z-1 left-0 top-0 absolute bg-black bg-opacity-20" />
      <div className="Frame427320969 py-20 pb-40 z-10 flex-col justify-start items-center gap-[72px] inline-flex">
        <div className="z-10 pt-3 flex-col justify-start items-center gap-[30px] flex">
          <div className="w-full h-6 text-center text-neutral-50 text-2xl font-bold font-['Neue Plak']">
        ...
        <div className="z-10 justify-between items-center gap-6 flex flex-col h-[100px] sm:flex-row">
          ...
          <div className="Frame427320972 bg-white bg-opacity-20 rounded-sm border border-neutral-50 flex-col justify-start items-center gap-5 inline-flex">
            <div className="Frame427320967 px-[50px] h-[50px] rounded-sm border-2 border-neutral-50 justify-center items-center gap-2.5 inline-flex">
              <div className="TITrIBNg text-neutral-50 text-base font-semibold font-['Montserrat']">
                TÀI TRỢ ĐỘI BÓNG
              </div>
            </div>
          </div>
